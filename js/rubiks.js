(function(){
    ...
    /* Need to write a function that grabs the data-alg="string"
     * string and replaces it with a random 2-Look OLL challenge
     * 
     */
    ...
    function initControls() {
        ...
        // this.inverseMovesList = inverseMovesList;
    };
    ...
    $(document).ready(function() {
        $('.glube').each(function(){
            ...
            /* No Need for a full scrambler button
             * $(this).find('.scramble-cube').click(function() {glube.scramble()}); 
             */
             
            /* However, it would be nice to do just OLL scrambles!
             * All we need to do it choose a random number and pull
             * a string out of an array of all the practice algorithms.
             */ 
            $(this).find('.ran-scramble').click(function() {
                glube.isInitializing = false;
                var allAlgs = ["R U2 R2- F R F- U2 R- F R F-", "R U B- R B R2 U- R- F R F-", "y R U- R2 D- r U- r- D R2 U R-", "r U R- U R- r2 U- R- U R- r2 U2 r-", "F R U R- U- F- f R U R- U- f-", "F R U R- U- S R U R- U- f-", "y r U r- U2 R U2 R- U2 r U- r-", "F R U r- U- R U R- M- U- F-", "y- f R U R- U- f- U- F R U R- U- F-", "r- R2 U R- U r U2 r- U M-", "r- R U R- F2 R U L- U L M-", "y F U R U- R- F- U F R U R- U- F-", "y- f R U R- U- f- U F R U R- U- F-", "M U- r U2 r- U- R U- R2 r", "y F U R U- R- F- U- F R U R- U- F-", "y- f R U R- d- l- F R U R- U- F-", "r- U2 R U R- U r", "y2 l- U2 L U L- U l", "y2 R- F2 r U r- F R", "L- U- L2 F- L- F2 U- F-", "r U2 R- U- R U- r-", "y2 l U2 L- U- L U- l-", "y2 R U R2 F R F2 U F", "y- x- D R2 U- R- U R- D- x", "r U R- U R U2 r-", "L- U2 L U2 L F- L- F", "F R- F- R U2 R U2 R-", "r U r- U R U- R- r U- r-", "y2 r- U- R U- R- U2 r", "l- U- L U- L- U2 l", "R U2 R- U2 R- F R F-", "F- L F L- U2 L- U2 L", "y R U R- U- R- F R2 U R- U- F-", "y2 R- U- R U- R- U R- F R F- U R", "r- R2 U2 R- U- R U- R- U- M-", "y- L- U- L U- L F- L- F L- U2 L", "R U R- U R- F R F- R U2 R-", "R U R- y R- F R U- R- F- R", "y2 L- U- L U L F- L2 U- L U F", "R U R- y- r- U r U- r- U- r", "r- R2 U R- U R U2 R- U M-", "M R U R- U R U2 R- U M-", "r U R- U R- F R F- R U2 r-", "y2 r U R- U R- F R F- R U2 r-", "F R U R- U- F- U F R U R- U- F-", "y- r R2- U- R U- R- U2 R U- R r-", "y M U2 R- U- R U- R- U2 R U M-", "y M L- U- L U- L- U2 L U- M-", "r U- r- U- r U r- F- U F", "F U R U- R2 F- R U R U- R-", "F U R U2 R- U- R U R- F-", "r U- r- U- r U r- y- R- U R", "R- F R U R- F- R F U- F-", "R- F R U R- F- R y- R U- R-", "F- U- r- F r2 U r- U- r- F r", "r- U r U r- U- r y R U- R-", "r- U- r R- U- R U r- U r", "y2 l- U- l L- U- L U l- U l", "r- U- M- U- R U r- U r", "y- R- U2 R U R- F U R U- R- F- R", "r U r- R U R- U- r U- r-", "r U M U R- U- r U- r-", "y2 R- F R U R- U- F- R U- R- U2 R", "y2 l U l- L U L- U- l U- l-", "R U R- U R- F R F- U2 R- F R F-", "f R U R- U- f- U- R U R- U- R- F R F-", "y2 F R- F- R2 r- U R U- R- U- M-", "y- F- r U r- U- S r- F r S-", "r U R- U R U2 r2 U- R U- R- U2 r", "y R U2 R2 F R F- U2 M- U R U- r-", "y2 F R U R- d R- U2 R- F R F-", "y2 F R U R- U y- R- U2 R- F R F-", "M U R U R- U- M- R- F R F-", "r- R U R U R- U- r R2- F R F-", "r- U2 R U R- U r2 U2 R- U- R U- r-", "R- U2 F R U R- U- F2 U2 F R", "M U R U R- U- M2 U R U- r-", "r U R- U- M2 U R U- R- U- M-", "M- U M- U M- U M- U- M- U M- U M- U M-", "M- U- R- U- R U M2- U- R- U r", "y R U2 R- U- R U R- U- R U- R-", "y F R U R- U- R U R- U- R U R- U- F-", "R U R- U R U- R- U R U2 R-", "R- U- R U- R- U R U- R- U2 R", "R U2 R2 U- R2 U- R2 U2 R", "f R U R- U- f- F R U R- U- F-", "R- U2 R2 U R2 U R2 U2 R-", "R U2- R2- U- R2 U- R2- U2 R", "R2 D R- U2 R D- R- U2 R-", "y2 R2 D- R U2 R- D R U2 R", "y R U R- U- R U- R- U2 R U- R- U2 R U R-", "R U R- U R U2 R2 U- R U- R- U2 R", "r U R- U- r- F R F-", "y2 l- U- L U R U- r- F", "y- x- R U R- D R U- R- D- x", "r U R- U- L- U R U- x-", "y F- r U R- U- r- F R", "R- F R B- R- F- R B", "F R- F- r U R U- r-", "y2 R U2 R- U- R U R- U- R U R- U- R U- R-", "y R U2 R- U- R U- R-", "R- U- R U- R- U2 R", "y2 L- U- L U- L- U2 L", "R- U L U- R U L-", "R U R- U R U2 R-", "y- R- U2 R U R- U R", "R U- L- U R- U- L", "y L- U2 L U L- U L", "r U R- U- M U R U- R-", "y2 M- U M U2 M- U M", "M U M- U2 M U M-", "y- M- U- M U2 M- U- M", "M U R U R- U- R- F R F- M-", "r2 D- r U r- D r2 U- r- U- r", "y R U R- U- R U- R- F- U- F R U R-", "y2 R- F R F- R U2 R- U- F- U- F", "M U- L- U- L U L F- L- F M-", "y- r- D- r U- r- D r2 U- r- U r U r-", "R2 U R- B- R U- R2 U R B R-", "y2 F R- F R2 U- R- U- R U R- F2", "R- U- F U R U- R- F- R", "y2 S- L- U- L U L F- L- f", "y- F R- F- R U R U R- U- R U- R-", "y S R U R- U- f- U- F", "S R U R- U- R- F R f-", "R U B- U- R- U R B R-", "y2 L U F- U- L- U L F L-", "R d L- d- R- U l U l-", "R U R- U- R- F R F-", "F R U- R- U R U R- F-", "y2 L- U- L U L F- L- F", "y- r- U- r- D- r U r- D r2", "y2 R U R- U- B- R- F R F- B", "y2 R U R2 U- R- F R U R U- F-", "F R U R- U- R- F- r U R U- r-", "y2 R U R- U- y- r- U- R U M-", "R U2 R2- F R F- R U2 R-", "f R U R- U- f- R U R- U R U2 R-", "y- R U2 R- U- R U- R- U2 F R U R- U- F-", "R U2 R- U- y- r- U r U- r- U- r", "y2 L- U- L U- L- U L U L F- L- F", "R- U- R U- R- U R U l U- R- U x", "R- U- R U- R- U R U R y R- F- R", "R U2 r D r- U2 r D- R- r-", "F R U- R- U- R U R- F-", "F R- F- R U R U- R-", "R- F R F- U- F- U F", "y- R U2 R- F R- F- R2 U2 R-", "R U R- U R U- R- U- R- F R F-", "L- U- L F L- U- L U L F- L- U L F- L- F", "y L F- L- U- L U F U- L-", "y- R U R- F- U- F U R U2 R-", "y- R B- R- U- R U B U- R-", "R- r- D- r U- r- D r U R", "y R- F R U R- U- F- U R", "R r D r- U r D- r- U- R-", "y- f R- F- R U R U- R- S-", "y- F R U R- U- F- R U R- U R U2 R-", "y2 R U R- U R U2- R- F R U R- U- F-", "R U- R- U2 R U y R U- R- U- F-", "y- L F- L- F L F- L- F L- U- L U L- U- L", "f R U R- U- f- U- R U R- U R U2 R-", "R- U- R U- R- U2 R F R U R- U- F-", "y R- F R F- R- F R F- R U R- U- R U R-", "L- U L U2 L- U- y- L- U L U F", "R- U R U2 R- U- F- U F U R", "f- L- U- L U f", "y2 F- U- L- U L F", "y R- U- F- U F R", "B- U- R- U R B", "f R U R- U- f-", "y2 F U R U- R- F-", "y2 r U x- R U- R- U x U- r-", "y- L d R U- R- F-", "F R U R- U- F-", "y2 f U R U- R- f-", "y2 F- L- U- L U F", "F R2 D R- U R D- R2 U- F-", "R- U- R- F R F- U R", "y F R U R- y- R- U R U2 R-", "y2 r- F- L- U L U- F r", "F- L- U- L U L- U- L U F", "R- U- R- F R F- R- F R F- U R", "R- U- l- U R U- R- U R U- x- U R", "y2 B- R- U- R U R- U- R U B", "F R U R- U- R U R- U- F-", "R U2 R- U- R U R- U2 R- F R F-", "y2 r U- r2 U r2 U r2 U- r", "l U- l2 U l2 U l2 U- l", "R B- R2 F R2 B R2 F- R", "y2 R- F R- F- R2 U2 B- R B R-", "r- U r2 U- r2- U- r2 U r-", "y2 R- F R2 B- R2 F- R2 B R-", "y- R U2 R- U- R U- R- F R U R- U- F-", "y2 l- U l2 U- l2 U- l2 U l-", "f R U R- U- R U R- U- f-", "y2 F U R U- R- U R U- R- F-", "y- R- U- R- F R F- R U- R- U2 R", "y2 f- L- U- L U L- U- L U f", "R U R- U R d- R U- R- F-", "R- U- R U- R- d R- U R B", "R- U- R U- R- U F- U F R", "R U R- U R U- y R U- R- F-", "r- U- R U- R- U R U- R- U2 r", "y2 l- U- L U- L- U L U- L- U2 l", "y r- U2 R U R- U- R U R- U r", "y- l- U2 L U L- U- L U L- U l", "r U R- U R U- R- U R U2 r-", "y- r U2 R- U- R U R- U- R U- r-", "F- L- U- L U L- U L U- L- U- L F", "y2 F R- F- R U2 F2 L F L- F", "R U2 R2 U- R U- R- U2 F R F-", "y R- F R U R U- R2 F- R2 U- R- U R U R-", "r U2 R2 F R F- U2 r- F R F-", "R- U2 R2 U R- U R U2 y R- F- R", "r U r- U R U- R- U R U- R- r U- r-", "F R U R- U- R F- r U R- U- r-", "r- U- r U- R- U R U- R- U R r- U r", "y f R U R- U- f- F R U R- U- R U R- U- F-", "R U R- U- M- U R U- r-", "M- U M- U M- U2 M U M U M", "R U R- U- r R- U R U- r-", "M- U M- U M- U M- U2 M- U M- U M- U M-"];
                var alg = allAlgs[Math.floor((Math.random() * allAlgs.length) - 0.00001)];
                var moves = glube.parseAlgorithm(alg);
                glube.doAlgorithm(moves);
            }); 
             // Opposite Algorithm 
            $(this).find('.opposite-alg').click(function() {
                glube.isInitializing = false; 
                var alg = "FRUR-U-F-";
                var moves = glube.parseAlgorithm(alg);
                glube.doAlgorithm(moves);
		     ...
		     // Adjacent Algorithm 
            $(this).find('.adjacent-alg').click(function() {
                glube.isInitializing = false; 
                var alg = "fRUR-U-f-";
                var moves = glube.parseAlgorithm(alg);
                glube.doAlgorithm(moves);
		     ...
		     // None Algorithm 
            $(this).find('.none-alg').click(function() {
                glube.isInitializing = false; 
                var alg = "FRUR-U-F-fRUR-U-f-";
                var moves = glube.parseAlgorithm(alg);
                glube.doAlgorithm(moves);
		    });
            // Sune Algorithm 
            $(this).find('.sune-alg').click(function() {
                glube.isInitializing = false; 
                var alg = "RUR-URU2R-";
                var moves = glube.parseAlgorithm(alg);
                glube.doAlgorithm(moves);
		    ...
		    // Anti-Sune Algorithm 
            $(this).find('.anti-sune-alg').click(function() {
                glube.isInitializing = false; 
                var alg = "R-U-RU-R-U2R";
                var moves = glube.parseAlgorithm(alg);
                glube.doAlgorithm(moves);
		    });
		    // Car Algorithm 
            $(this).find('.car-alg').click(function() {
                glube.isInitializing = false; 
                var alg = "FRUR-U-RUR-U-RUR-U-F-";
                var moves = glube.parseAlgorithm(alg);
                glube.doAlgorithm(moves);
		    });
		    // Blinker Algorithm 
            $(this).find('.blinker-alg').click(function() {
                glube.isInitializing = false; 
                var alg = "RU2R2U-R2U-R2U2R";
                var moves = glube.parseAlgorithm(alg);
                glube.doAlgorithm(moves);
		    });
		    // Headlights Algorithm 
            $(this).find('.headlights-alg').click(function() {
                glube.isInitializing = false; 
                var alg = "R2DR-U2RD-R-U2R-";
                var moves = glube.parseAlgorithm(alg);
                glube.doAlgorithm(moves);
		    });
		    // Chameleon Algorithm 
            $(this).find('.chameleon-alg').click(function() {
                glube.isInitializing = false; 
                var alg = "rUR-U-r-FRF-";
                var moves = glube.parseAlgorithm(alg);
                glube.doAlgorithm(moves);
		    ...
		    // Bowtie Algorithm 
            $(this).find('.bowtie-alg').click(function() {
                glube.isInitializing = false; 
                var alg = "F-rUR-U-r-FR";
                var moves = glube.parseAlgorithm(alg);
                glube.doAlgorithm(moves);
		    });
		    // Rotate the whole cube y
            $(this).find('.y-alg').click(function() {
                glube.isInitializing = false; 
                var alg = "y";
                var moves = glube.parseAlgorithm(alg);
                glube.doAlgorithm(moves);
		    ...
		    // Rotate the whole cube y'
            $(this).find('.yp-alg').click(function() {
                glube.isInitializing = false; 
                var alg = "y-";
                var moves = glube.parseAlgorithm(alg);
                glube.doAlgorithm(moves);
